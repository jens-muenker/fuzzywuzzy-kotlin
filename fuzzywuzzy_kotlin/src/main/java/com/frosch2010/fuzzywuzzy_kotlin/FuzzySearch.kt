...
import com.frosch2010.fuzzywuzzy_kotlin.algorithms.TokenSet
import com.frosch2010.fuzzywuzzy_kotlin.algorithms.TokenSort
...
object FuzzySearch {
    ...
    fun extractTop(
        ...
        func: Applicable, limit: Int, cutoff: Int
     ...
     */
    fun extractSorted(
        query: String, choices: Collection<String>, func: Applicable,
        cutoff: Int
    ): List<ExtractedResult> {
        val extractor = Extractor(cutoff)
        return extractor.extractTop(query, choices, func)
    ...
    fun <T> extractTop(
        query: String, choices: Collection<T>,
        toStringFunction: ToStringFunction<T>, limit: Int, cutoff: Int
    ): List<BoundExtractedResult<T>> {
        val extractor = Extractor(cutoff)
    ...
    fun <T> extractTop(
        query: String, choices: Collection<T>,
        toStringFunction: ToStringFunction<T>, limit: Int
    ): List<BoundExtractedResult<T>> {
        val extractor = Extractor()
        return extractor.extractTop(query, choices, toStringFunction, WeightedRatio(), limit)
    }
    ...
    fun <T> extractSorted(
        query: String, choices: Collection<T>,
        toStringFunction: ToStringFunction<T>, cutoff: Int
    ): List<BoundExtractedResult<T>> {
        val extractor = Extractor(cutoff)
        return extractor.extractTop(query, choices, toStringFunction, WeightedRatio())
    }
